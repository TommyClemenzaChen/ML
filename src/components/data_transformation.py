...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("Splitting the input and target features")
            ...
            logging.info("Recombining the input and target features")
            # c_ is shorthand for column stack which stacks 1D arrays as columns into a 2D array
            # combining the input and target features after preporcessing
            train_arr = np.c_[
